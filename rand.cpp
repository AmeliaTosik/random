...
int main() {
    ...
    cout << wysz_liniowe(tab2, rozmiar, liczba2) << endl;
 
    cout << wysz_binarne(tab2, 0, rozmiar, liczba1) << " ";
    cout << wysz_binarne(tab2, 0, rozmiar, liczba2) << endl;
 
    cout << wysz_interpolacyjne(tab2, 0, rozmiar, liczba1) << " ";
    cout << wysz_interpolacyjne(tab2, 0, rozmiar, liczba2) << endl;
 
    cout << wysz_skokowe(tab2, rozmiar, liczba1) << " ";
    cout << wysz_skokowe(tab2, rozmiar, liczba2) << endl;
};